...
public class Peminjaman {
            ...
            while (stay) {
                ...
                if (menu == 1) {
                    ...
                    System.out.println("ID 1 = Radit");
                    System.out.println("ID 2 = Aurel");
                    System.out.println("ID 3 = Rifa");
                    System.out.println();
...
//PE:name class ,digunakan untuk menyatakan object baru pada clas petugas
//pet:object baru
//New=keywoard
//petugas();=construktor
//if yaitu percabangan yng hanya memiliki 1 blok pilihan saat kondisi bernilai benar
//while perulangan
//boolean percabangan,untuk mewakili nilai yang benar dan salah pada data